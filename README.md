...
| 🌐 **WEB/SEO аудит** | Самостоятельный анализатор сайтов (локальный dev-сервер **или** внешний домен): свой список сайтов и **история аудитов** с дельтой. Заголовки безопасности с оценкой, **TLS-сертификат**, экспонированные `.git/.env`, SEO-мета из **отрендеренной** страницы (скрытый Chromium), **Core Web Vitals** и вес страницы, скриншоты, техстек, **битые ссылки**, robots/sitemap, DNS · SPF/DMARC · WHOIS · гео. Находки можно **передать агенту** одной кнопкой; результаты приходят поэтапно. |
