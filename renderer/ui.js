...
export const ICONS = {
  ...
  // «Обработка текста» (Obsidian-редизайн, PR #6): тулбар/пилл/сайдбар
  underline: '<path d="M7 5v6a5 5 0 0 0 10 0V5"/><path d="M6 19h12"/>',
  undo: '<path d="M4 9.5h10a5 5 0 0 1 0 10H9"/><path d="M8 5.5l-4 4 4 4"/>',
  redo: '<path d="M20 9.5H10a5 5 0 0 0 0 10h5"/><path d="M16 5.5l4 4-4 4"/>',
  ...
  'list-ol': '<path d="M10 6h10M10 12h10M10 18h10"/><path d="M4 5h1.4v3.7M3.7 8.7h1.7"/><path d="M3.6 14.4c0-.6.5-1 1.1-1s1.1.4 1.1 1c0 1-2.1 1.4-2.1 2.6h2.2"/>',
  'columns-2': '<rect x="3.5" y="4.5" width="17" height="15" rx="2"/><path d="M12 4.5v15"/>',
  'table-insert': '<rect x="3.5" y="4.5" width="13.5" height="15" rx="2"/><path d="M3.5 9.5H17M9 4.5v15"/><path d="M18.5 14.5v6M15.5 17.5h6"/>',
  panels: '<rect x="3.5" y="4.5" width="17" height="15" rx="2"/><path d="M14.5 4.5v15"/>',
  ...
  'obs-collapse': '<path d="M6 13.5l6-6 6 6"/><path d="M6 19.5l6-6 6 6"/>',
